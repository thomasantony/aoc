...
mod tests {
    ...
    fn unit_tests_day_05() {
        ...
        assert_eq!(vm.load_program(&large_program).set_input(7).execute(), 999);
        assert_eq!(vm.load_program(&large_program).set_input(8).execute(), 1000);
        assert_eq!(vm.load_program(&large_program).set_input(9).execute(), 1001);
    }
}
